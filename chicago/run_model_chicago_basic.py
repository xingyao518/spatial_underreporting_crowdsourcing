...
from stan_model.prepare_stan_data_basic import *
...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_name", type = str, default = 'chicago_basic')
    parser.add_argument("--iter_warmup", type=int, default=50)
    parser.add_argument("--iter_sampling", type=int, default=100)
    parser.add_argument("--max_incidents", type=int, default=500)
    ...
    run_model(modelname = args.model_name, iter_warmup=args.iter_warmup, iter_sampling=args.iter_sampling, max_incidents=args.max_incidents, save_label=args.save_label, settings_name=args.settings_name, show_progress=True)