...
def plot_map_of_colors(
    ...
    hue_col="lambdaval",
    shpfilename="data/shapefiles/tl_2020_17_bg.shp",
    ...
    gplt.choropleth(gpd.GeoDataFrame(dflocjoin),
                    hue=hue_col, legend=True, linewidth=0, legend_kwargs={'shrink': 0.7}, projection = gcrs.AlbersEqualArea(), cmap = 'gist_heat')
