...
def latexify(fig_width=None, fig_height=None, columns=1):
    ...
    params = {
        # 'backend': 'ps',
        "pgf.rcfonts": False,
        "pgf.preamble": r"\usepackage{gensymb,amsmath} \usepackage[dvipsnames]{xcolor} \usepackage{lmodern}",
        "pgf.texsystem": "pdflatex",
        "text.latex.preamble": r"\usepackage{gensymb,amsmath} \usepackage[dvipsnames]{xcolor} \usepackage{lmodern}",
...
def saveimage(name, fig=plt, extension="pdf", folder="plots/", close=True, despineandgrid = True):
    if despineandgrid:
        sns.despine()
