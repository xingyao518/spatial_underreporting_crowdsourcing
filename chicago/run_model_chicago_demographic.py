...
from stan_model.prepare_stan_data_demographic import *
...
def run_model(modelname, 
        ...
        settings = None, force_compile = False, save_label = '', settings_name = '', show_progress = False,
        tract11_or_block12 = 11):
